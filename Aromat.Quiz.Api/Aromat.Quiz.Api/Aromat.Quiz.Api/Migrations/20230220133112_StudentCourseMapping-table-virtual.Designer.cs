...
namespace Aromat.Quiz.Api.Migrations
{
    ...
    [Migration("20230220133112_StudentCourseMapping-table-virtual")]
    partial class StudentCourseMappingtablevirtual
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aromat.Quiz.Api.Model.StudentCourseMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CourseDetailsStudentCourseMapping", b =>
                {
                    b.Property<int>("CourseDetailsId")
                        .HasColumnType("int");

                    b.Property<int>("StudentCoursesMappingId")
                        .HasColumnType("int");

                    b.HasKey("CourseDetailsId", "StudentCoursesMappingId");

                    b.HasIndex("StudentCoursesMappingId");

                    b.ToTable("CourseDetailsStudentCourseMapping");
                });
            ...
            modelBuilder.Entity("CourseDetailsStudentCourseMapping", b =>
                {
                    ...
                    b.HasOne("Aromat.Quiz.Api.Model.StudentCourseMapping", null)
                        .WithMany()
                        .HasForeignKey("StudentCoursesMappingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });

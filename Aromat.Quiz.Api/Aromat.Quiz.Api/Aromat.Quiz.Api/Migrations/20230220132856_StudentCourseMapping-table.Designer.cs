...
namespace Aromat.Quiz.Api.Migrations
{
    ...
    [Migration("20230220132856_StudentCourseMapping-table")]
    partial class StudentCourseMappingtable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aromat.Quiz.Api.Model.StudentCourseMapping", b =>
                {
                    b.HasOne("Aromat.Quiz.Api.Model.CourseDetails", null)
                        .WithMany("StudentCoursesMapping")
                        .HasForeignKey("CourseDetailsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Aromat.Quiz.Api.Model.CourseDetails", b =>
                {
                    ...
                    b.Navigation("StudentCoursesMapping");
                });
